...
<div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-4">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Supplier Master List</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <a href="suppliermasteradd.php"><button class="btn btn-primary btn-md ">
  ...
  ?>
        ...
        <tr>
               ...
               <td>
                    <a href='suppliermasterupdate.php?id=<?php echo $row['Id'];?>'>Update</a> 
                    <a href='suppliermasterdeletedata.php?id=<?php echo $row['Id'];?>'>Delete</a>
                </td>
           </tr>
            <?php } ?>
        </tbody>
