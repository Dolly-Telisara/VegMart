				...
				<div class="row">
                    ...
                    <div class="col-md-5">
						<div class="product-details">
							...
							<div>
								<h3 class="product-old-price"><i class="fa fa-inr">'.$row['product_discount'].' </i></h3>
								<h4 class="product-price"><del class="product-old-price"><i class="fa fa-inr"></i>'.$row['product_price'].'</del></h4>
                        ...
                        echo "
								...
								<a href='product.php?p=$pro_id'><div class='product'>
									...
									<div class='product-body'>
										...
										<h4 class='product-price header-cart-item-info'><i class='fa fa-inr'></i>$pro_discount
										</h4>	
										<h4 class='product-old-price'><del class='product-old-price'><i class='fa fa-inr'></i>$pro_price</del></h4>
