                        ...
                        <div class='col-md-4 col-xs-6' >
								<a href='product.php?p=$pro_id'><div class='product'>
									...
									<div class='product-body'>
										...
										<h4 class='product-price header-cart-item-info'>$pro_discount<del class='product-old-price'>$pro_price</del></h4>
...
if (isset($_POST["Common"])) {
	...
	if (isset($_SESSION["uid"])) {
		...
		$sql = "SELECT a.product_id,a.product_title,a.product_discount,a.product_image,b.id,b.qty FROM products a,cart b WHERE a.product_id=b.p_id AND b.user_id='$_SESSION[uid]'";
	}else{
		//When user is not logged in this query will execute
		$sql = "SELECT a.product_id,a.product_title,a.product_discount,a.product_image,b.id,b.qty FROM products a,cart b WHERE a.product_id=b.p_id AND b.ip_add='$ip_add' AND b.user_id < 0";
	}
	$query = mysqli_query($con,$sql);
	if (isset($_POST["getCartItem"])) {
		...
		if(mysqli_num_rows($query) > 0) {
				...
				echo '
                    ...
                    <div class="product-widget">
												...
												<div class="product-body">
													...
													<h4 class="product-price"><span class="qty">'.$n.'</span><i class="fa fa-inr">' .$product_price.'</i></h4>
												</div>
           ...
           // <i class="fa fa-inr">'.$row['product_discount'].' </i>
			
            echo '<div class="cart-summary">
				    <small class="qty">'.$n.' Item(s) selected</small>
				    <h5><i class="fa fa-inr">' .$total_price.'</i></h5>
				</div>'
            ?>
				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="checkout.php" method="post">
							...
							<!--input type="hidden" name="business" value="shoppingcart@vegmart.com"-->
							...
							while($row=mysqli_fetch_array($query)){
								...
								echo  	
									...
									<input type="hidden" name="item_name_'.$x.'" value="'.$row["product_title"].'">
								     ...
								     <input type="hidden" name="amount_'.$x.'" value="'.$row["product_discount"].'">
